document.addEventListener("DOMContentLoaded", function() {
    ...
    const mainMessage = "hello, i want to apologize for the dry texts i sent you. none of it was intentional and whatever happened between us was never your fault. it was all on me, on how i acted, jumping to conclusions about what i saw without thinking clearly, which led me to be delusional. the first thing that went through my head was believing that you were leading on a bunch of guys instead of trusting what you kept telling me, that you were ignoring them. the second thing was thinking that if i ignored you, you would start to lose interest. that approach painfully backfired on me because i didn't consider how you would feel and now i think about it all the time. you also said, 'it's not me, then it can't be anyone else,' which was very sweet and made me feel soft. i really fumbled this situation and i feel very guilty for my actions. however, i will try to be a better person, whether for you or for whoever comes next, so that i won’t make such dumb decisions in life again. i'm saying this all off the top of my head so this isn’t everything. you can either leave it here or respond to me if you want to ask more. i’ll give you the closure you need.❤️";
